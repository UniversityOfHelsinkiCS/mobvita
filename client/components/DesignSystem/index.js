      ...
      <div style={{ maxWidth: 1040, margin: '0 auto', padding: '2rem' }}>
        ...
        <Section title="AppIcon — one asset, any token colour (ready for a dark theme)">
          <div style={{ display: 'flex', gap: 28, alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <div style={{ fontSize: 12, color: colors.muted, maxWidth: 260 }}>
              The same <code>cards.svg</code> in four colours. An <code>&lt;img&gt;</code> would
              need four files and could not follow a theme.
            </div>
          </div>
        </Section>
        ...
        <Section title="AppButton — sizes (sm / md / lg)">
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <AppButton variant="tan" size="sm">
              Button
            </AppButton>
            <AppButton variant="tan">Button</AppButton>
            <AppButton variant="tan" size="lg">
              Button
            </AppButton>
          </div>
        </Section>
          ...
          {(() => {
            ...
            return (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20, width: '100%' }}>
                ...
                <div style={{ maxWidth: 620 }}>
                  <div style={{ fontSize: 13, color: colors.muted, marginBottom: 6 }}>
                    Inner tab panel (<code>bordered</code>) — a green outline so the bar reads when
                    it sits inside a cream card or modal (e.g. Flashcards, the learning-settings
                    modal). Shown on a cream surface, which is the only place the outline earns its
                    keep.
                  </div>
            ...
            return (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 24, width: '100%' }}>
                {[
                  ...
                  {
                    title: 'plain + striped + bordered',
                    props: { plain: true, striped: true, bordered: true },
                  },
                ...
                <div style={{ maxWidth: 420 }}>
                  <div style={{ fontSize: 13, color: colors.muted, marginBottom: 6 }}>
                    Too many columns — the <code>TableContainer</code> scrolls horizontally , so a
                    wide table never breaks the page layout. This is what the group summary table
                    relies on.
                  </div>
        ...
        <Section title="AppMenu (click the burger)">
          ...
          >
            ...
            <AppMenuItem
              icon={<img src={images.mail05} alt="" style={{ width: 22, height: 22 }} />}
            >
              Contact Us
            </AppMenuItem>
            <AppMenuItem
        ...
        <Section title="AppDialog">
          ...
          <AppDialog open={dialogOpen} onClose={() => setDialogOpen(false)} title="Example dialog">
            <p style={{ color: colors.ink }}>
              This is an AppDialog — cream card, ink text, rounded corners, close button. Long
