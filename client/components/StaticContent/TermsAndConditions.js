...
const TermsAndConditions = ({ trigger, open: controlledOpen, setOpen: setControlledOpen }) => {
    ...
    <>
      ...
      >
        <div data-cy="tc-content">
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By using Revita's website you consent to the use of
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, Revita and/or it's licensors own the intellectual property
            rights for all material on Revita. All intellectual property rights are reserved. You
            may view and/or print pages from https://revita.helsinki.fi/ for your own personal use
          ...
          <p>
            ...
            the visibility associated with the hyperlink outweighs the absence of Revita; and (d)
          ...
          <p>
            ...
            linking to our website, you must contact us with our webform. Please include your name,
          ...
          <p>
            It is Revita's policy to respect your privacy regarding any information we may collect
            ...
            applies to information we collect through the Website.
          </p>
          <p>
          ...
          <p>
            Like most website operators, Revita collects non-personally-identifying information of
            ...
            request. Revita's purpose in collecting non-personally identifying information is to
            better understand how Revita's visitors use its website. From time to time, Revita may
          ...
          <p>
            Revita also collects potentially personally-identifying information like Internet
            Protocol (IP) addresses for logged in users. Revita only discloses logged in user and
            commenter IP addresses under the same circumstances that it uses and discloses
            personally-identifying information as described below.
          </p>
          <h2>Gathering of Personally-Identifying Information</h2>
          <p>
            Visitors to Revita's websites may choose to interact with Revita in ways that require
            Revita to gather personally-identifying information. The amount and type of information
            that revita gathers depends on the nature of the interaction. For example, we ask
            visitors who sign up to provide a username and email address. Additionally, Revita
            gathers data on visitor behaviour and actions related to using Revita and its language
            learning features in order to conduct scientific research and to improve Revita.
          </p>
          <h2>Security</h2>
          <p>
          ...
          <p>
            Revita discloses potentially personally-identifying and personally-identifying
            information only to those of its employees, contractors and affiliated organizations
            that (i) need to know that information in order to process it on Revita's behalf or to
            provide services available at Revita's website, and (ii) that have agreed not to
            disclose it to others. Some of those employees, contractors and affiliated organizations
            may be located outside of your home country; by using Revita's website, you consent to
            the transfer of such information to them. Revita will not rent or sell potentially
            personally-identifying and personally-identifying information to anyone. Other than to
            its employees, contractors and affiliated organizations, as described above, Revita
            discloses potentially personally-identifying and personally-identifying information only
            in response to a subpoena, court order or other governmental request, or when Revita
            believes in good faith that disclosure is reasonably necessary to protect the property
            or rights of Revita, third parties or the public at large.
          </p>
          <p>
            If you are a registered user of https://revita.helsinki.fi/ and have supplied your email
            address, Revita may occasionally send you an email to tell you about new features,
            solicit your feedback, or just keep you up to date with what's going on with Revita and
            our products. We primarily use our blog to communicate this type of information, so we
            expect to keep this type of email to a minimum. If you send us a request (for example
            via a support email or via one of our feedback mechanisms), we reserve the right to
            publish it in order to help us clarify or respond to your request or to help us support
            other users. Revita takes all measures reasonably necessary to protect against the
          ...
          <h2>Cookies</h2>
          <p>
            To enrich and perfect your online experience, Revita uses "Cookies", similar
          ...
          <p>
            ...
            that the visitor's browser provides to the website each time the visitor returns. Revita
            uses cookies to help Revita identify and track visitors, their usage of
            https://revita.helsinki.fi/, and their website access preferences. Revita visitors who
            do not wish to have cookies placed on their computers should set their browsers to
            refuse cookies before using Revita's websites, with the drawback that certain features
            of Revita's websites may not function properly without the aid of cookies.
          </p>
          <p>
          ...
          <p>
            Although most changes are likely to be minor, Revita may change its Privacy Policy from
            time to time, and in Revita's sole discretion. Revita encourages visitors to frequently
            check this page for any changes to its Privacy Policy. Your continued use of this site
